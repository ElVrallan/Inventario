...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <a href="{{ route('productos.create') }}"
        class="fab-add-producto fixed bottom-8 right-8 bg-blue-500 hover:bg-blue-600 text-white rounded-full p-3 shadow-lg transition-all duration-300 hover:scale-110"
        aria-label="Agregar producto" title="Agregar producto">
        <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" fill="currentColor" class="bi bi-bag-plus"
            viewBox="0 0 16 16">
