...
<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="mt-4">
            ...
            <div class="flex">
                <x-text-input id="password" class="flex-1" type="password" name="password" required autocomplete="current-password" />
                <button type="button" class="ml-2 password-toggle-button" onclick="togglePasswordVisibility()">
